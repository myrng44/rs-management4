...
public class StoreTransferController extends AuditedCrudController<StoreTransferDto, StoreTransfer, Long, UserGetDto, Long, StoreTransferDto, StoreTransferDto> {
