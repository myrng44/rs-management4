...
public class CustomerCrudServiceImpl extends FullAuditedCrudServiceImpl<CustomerDto, Customer, Long, UserGetDto, Long> {
    ...
    public Map<String, List<SearchOperator>> getSearchableKeys() {
        ...
        keys.put("point", List.of(SearchOperator.EQUALS,
