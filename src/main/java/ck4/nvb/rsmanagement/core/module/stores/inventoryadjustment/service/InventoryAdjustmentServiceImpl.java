...
public class InventoryAdjustmentServiceImpl extends FullAuditedCrudServiceImpl<InventoryAdjustmentDto, InventoryAdjustment, Long, UserGetDto, Long> {
    ...
    public Map<String, List<SearchOperator>> getSearchableKeys() {
        ...
        keys.put("changeQuantity", List.of(SearchOperator.BETWEEN,
