...
public class UserRoleServiceImpl extends FullAuditedCrudServiceImpl<UserRoleDto, UserRole, Long, UserGetDto, Long> implements FullAuditedCrudService<UserRoleDto, UserRole, Long, UserGetDto, Long> {
