...
public class BatchItemServiceImpl
    extends FullAuditedCrudServiceImpl<BatchItemDto, BatchItem, Long, UserGetDto, Long>
    implements IBatchItemService {
  ...
  @Override
  public BatchItemDto update(Long aLong, UpdateInput<BatchItem> updateDto, UserGetDto user)
      throws AppException {
  ...
  @Override
  public List<BatchItemDto.WithBatchInfo> findAvailableBatchesInfoForProduct(
      Long productId, Long storeId) {
    List<Map<String, Object>> result =
        getRepository().findAvailableBatchesInfoForProduct(productId, storeId);

    return result.stream()
        .map(
            row ->
                new BatchItemDto.WithBatchInfo(
  ...
  @Override
  public List<BatchItemDto.WithBatchInfo> findAllByBatchId(Long batchId) {
    List<Map<String, Object>> result = getRepository().findAllByBatchId(batchId);
    return result.stream()
        .map(
            row ->
                new BatchItemDto.WithBatchInfo(
