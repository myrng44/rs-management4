...
//    }
//
//    private ProfileRequest toUserResponseDTO(Users user) {
//        List<String> roleNames = user.getUserRoles().stream()
//                .map(userRole -> userRole.getRole().getName())
//                .collect(Collectors.toList());
//
//        return new ProfileRequest(user.getUsername(), roleNames);
//    }
//
//    public List<ProfileRequest> getAllUserDTO() {
//        List<Users> users = getAllUsers();
//        List<ProfileRequest> result = new ArrayList<>();
//        for (Users user : users) {
//            ProfileRequest userResponseDTO = toUserResponseDTO(user);
//            result.add(userResponseDTO);
//        }
//        return result;
//    }
//
//    public Users saveUserDTO(ProfileResponse dto) {
//        var user = new Users();
