...
@MappedSuperclass
public abstract class AuditedEntity<ID extends Comparable<ID> & Serializable, UID extends Comparable<UID> & Serializable> extends CreationAuditedEntity<ID, UID> implements Audited<UID> {
