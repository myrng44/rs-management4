...
@MappedSuperclass
public abstract class FullAuditedEntity<ID extends Comparable<ID> & Serializable, UID extends Comparable<UID> & Serializable> extends
    AuditedEntity<ID, UID> implements FullAudited<UID>, SoftDeletable {
    // Fields
