...
public final class APIResponseBuilder {
  ...
  public static <T> APIResponses<T> success(T data, String message) {
    ...
    return new APIResponses<>(header, data);
  }
  ...
  // created
  public static <T> APIResponses<T> created(T data, String message) {
  ...
  // No content
  public static <T> APIResponses<T> noContent(String message) {
    APIResponseHeader header = new APIResponseHeader(ErrorCode.NO_CONTENT.getValue(), message);
    setCommonHeaderFields(header);
    return new APIResponses<>(header, null);
  }
