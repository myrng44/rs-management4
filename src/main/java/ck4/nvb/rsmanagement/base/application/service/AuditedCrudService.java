...
public interface AuditedCrudService<D extends EntityDto<ID>, T extends IEntity<ID> & Audited<UID>, ID extends Comparable<ID> & Serializable, U extends EntityDto<UID>, UID extends Comparable<UID> & Serializable>
