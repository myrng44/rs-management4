...
public class MissingRequiredPropertyException extends AppException {
    ...
    public MissingRequiredPropertyException(List<FieldError> fieldErrors, String message, Object... arguments) {
    ...
    public MissingRequiredPropertyException(List<FieldError> fieldErrors, String message, Throwable cause) {
