...
@Transactional
public abstract class AuditedCrudServiceImpl<D extends EntityDto<ID>, T extends IEntity<ID> & Audited<UID>, ID extends Comparable<ID> & Serializable, U extends EntityDto<UID>, UID extends Comparable<UID> & Serializable>
        extends CreationAuditedCrudServiceImpl<D, T, ID, U, UID> implements AuditedCrudService<D, T, ID, U, UID> {
