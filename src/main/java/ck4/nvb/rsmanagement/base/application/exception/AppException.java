...
public class AppException extends RuntimeException {
     ...
     * {@link #AppException(String)} constructor to specify a helpful message to the end user
     */
    public AppException() {
    }
    ...
    /**
     * Constructor used to simply chain a parent exception cause to an AppException. Preference
     * should be given to the {@link #AppException(String, Throwable)} constructor if at all
