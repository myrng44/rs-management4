...
@Transactional
public abstract class FullAuditedCrudServiceImpl<D extends EntityDto<ID>, T extends IEntity<ID> & FullAudited<UID>, ID extends Comparable<ID> & Serializable, U extends EntityDto<UID>, UID extends Comparable<UID> & Serializable>
