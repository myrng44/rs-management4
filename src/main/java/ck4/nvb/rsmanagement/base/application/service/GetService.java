...
public interface GetService<D extends EntityDto<ID>, T extends IEntity<ID>, ID extends Comparable<ID> & Serializable> {
     ...
     * @return a page of objects of the given class
     */
    PagedResultDto<D> getPage(List<SearchCriteria> filter, PagedAndSortedResultRequestDto paging) throws AppException;
}
