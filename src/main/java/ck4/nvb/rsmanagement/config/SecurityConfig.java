...
import ck4.nvb.rsmanagement.core.auth.filter.JwtFilterRequest;
...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/register", "/send-reset-otp", "/reset-password", "/logout", "/swagger-ui/**",
                                "/swagger-ui.html",
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173/", "http://localhost:6969", "http://localhost:6969/actuator/mappings"));
